...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', 'unset' for activities with no difficulty level set)
    """
    ...
    if difficulty:
        if difficulty == "unset":
            # "unset" means activities with no difficulty field (suitable for all levels)
